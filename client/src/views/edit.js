...
import { isUserAdmin, getProductById, editPartById } from '../api/data.js';

const editTemplate = (productData, onSubmit) => html `
    <div class="creatediv">
            ...
            <div class="form-inputs">
                <div class="form-input">
                    ...
                    <div class="image">
                        <span>Снимка</span>
                        <div class="select">
                            <input type="text" placeholder="" name="imageUrl" .value=${productData.imageUrl}>
                        </div>
                    </div>
                    <div class="condition">
                        <span>Състояние</span>
                    ...
                    <div class="title">
                        <span>Заглавие *</span>
                        <div class="select">
                            <input type="text" placeholder="" name="title" .value=${productData.title}>
                        </div>
                    </div>
                    ...
                    <div class="price">
                        <span>Цена *</span>
                        <div class="select">
                            <input type="text" placeholder="" name="price" .value=${productData.price}>
                        </div>
                    </div>
                </div>
            </div>
...
export async function editPage(ctx) {
    ...
    ctx.render(editTemplate(productData, onSubmit));
    ...
    async function onSubmit(e) {
        ...
        console.log(category, type, brand, model, yearFrom, yearTo, engineType, partColor, imageUrl, condition, title, price);
